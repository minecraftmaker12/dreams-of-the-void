...
public class ZynnStalkBlock extends DreamsOfTheVoidModElements.ModElement {
	@ObjectHolder("dreams_of_the_void:zynn_stalk")
	public static final Block block = null;

	public ZynnStalkBlock(DreamsOfTheVoidModElements instance) {
		super(instance, 2);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("zynn_stalk"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dreams_of_the_void:zynn_stalk"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		...
		public boolean isValidPosition(BlockState blockstate, IWorldReader worldIn, BlockPos pos) {
			...
			return ground == this || (ground == ZynnMossBlock.block
